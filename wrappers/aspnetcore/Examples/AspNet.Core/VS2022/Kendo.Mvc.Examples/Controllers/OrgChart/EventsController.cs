...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class OrgChartController : Controller
    {
        ...
        {
            List<OrgChartEmployeeViewModel> result = EventsOrgChartData;
        ...
        private List<OrgChartEmployeeViewModel> EventsOrgChartData
        {
            get
            {
                List<OrgChartEmployeeViewModel> source = HttpContext.Session.GetObjectFromJson<List<OrgChartEmployeeViewModel>>("EventsOrgChartEmployees");
                ...
                if (source == null)
                {
                    ...
                    HttpContext.Session.SetObjectAsJson("EventsOrgChartEmployees", source);
                }
                return source;
            }
            set
            {
                HttpContext.Session.SetObjectAsJson("EventsOrgChartEmployees", value);
            }
        }
    }
}