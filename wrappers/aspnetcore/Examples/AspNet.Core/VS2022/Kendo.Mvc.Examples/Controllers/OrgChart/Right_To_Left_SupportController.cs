...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class OrgChartController : Controller
    {
        ...
        public JsonResult RightToLeftSupportData([DataSourceRequest] DataSourceRequest request)
        {
            ...
            source.Add(new OrgChartEmployeeViewModel() { ID = 4, Name = "Kendra Howell", Title = "CMO", Expanded = false, ParentID = 1, Avatar = "../shared/web/treelist/people/4.jpg" });
            ...
            source.Add(new OrgChartEmployeeViewModel() { ID = 14, Name = "Elena Austin", Title = "Team Lead", ParentID = 4, Avatar = "../shared/web/treelist/people/14.jpg" });
            source.Add(new OrgChartEmployeeViewModel() { ID = 15, Name = "Lora Samuels", Title = "Lawyer", ParentID = 4, Avatar = "../shared/web/treelist/people/15.jpg" });
