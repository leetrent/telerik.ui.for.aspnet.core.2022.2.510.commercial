...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class UploadController : Controller
    {
        ...
        public async Task<ActionResult> Directory_Upload_Chunk_Save(IEnumerable<IFormFile> files, string metaData)
        {
            if (metaData == null)
            {
                return await Directory_Upload_Save(files);
            }
        ...
        public async Task<ActionResult> Directory_Upload_Save(IEnumerable<IFormFile> files)
        {
            // The Name of the Upload component is "files"
            if (files != null)
            {
