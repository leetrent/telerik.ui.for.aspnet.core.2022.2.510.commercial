...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class PdfProcessingController : Controller
    {
        ...
        public ActionResult Merge_Split_Add_Append_Prepend(IFormFile firstDocument, IFormFile secondDocument, string rb)
        {
            ...
            if(rb == "4" && firstDocument != null)
            {
                ...
                short filesToMurge = 2;
                MemoryStream ms = new MemoryStream();
                string fileName = @"wwwroot/shared/web/pdfprocessing/template.pdf";
