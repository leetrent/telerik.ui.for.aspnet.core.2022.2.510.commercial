        ...
        public JsonResult GetHorizontalEvents()
        {
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Barcelona_Tenerife.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/United_States_East_Coast_tour_1.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Malta_a_country _of_knights.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Wonders_of_Italy.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/The_Best_of_Western_Europe.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/UNESCO_sites_in_Bulgaria.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/India_Golden_Triangle_Khajuraho_and_Varanasi.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Grand_tour_of_France.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Costa_Rican_Treasures.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Brazil_Argentina_Iguazu_Falls.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Cuba_Paradise_Island.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Egypt_Explorer.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/England_Scotland_Wales.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Golden_Myanmar.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Imperial_China.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Kenya.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/United_States_East_Coast_tour_2.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/Spectacular_Highlights_of_Turkey_and_Greece.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/The_best_of_Japan.jpg" }
                }
            });
            ...
            events.Add(new TimelineEventModel()
            {
                ...
                Images = new List<TimelineEventModelImage>() {
                    new TimelineEventModelImage() { src = "../shared/web/timeline/images/The_Best_of_Central_Europe.jpg" }
                }
            });
